...
//    ولا يُرسَل الفراغ أبداً: Laravel يحوّل الفارغ القادم في الطلب إلى null فيُقرأ
//    «لم يُحدَّد» ويُطبَّق الافتراضي «مشترك» — وهذا بالضبط ما أوصل موظفاً بلا تأمين
//    مشتركاً. فيُرسَل الرمز 'none' كما هو، والطرف الآخر يحوّله عند التخزين.
const INSURANCE = [
  { value: 'commercial_record', label: 'مشترك في التأمينات الاجتماعية' },
  { value: 'none',              label: 'بدون تأمين' },
];

/** قيمة نوع التأمين كما تُرسَل للنظام الأساسي: 'none' صريحة، وnull لما لم يُحدَّد */
const insuranceTypeForSync = (v) => (v === 'none' || v === 'commercial_record' ? v : null);
